        ...
        <div className="space-y-4">
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
            ...
            <ol className="text-sm text-muted-forground space-y-1 list-decimal list-inside">
              ...
              <li>Save and copy the singing secret</li>
            </ol>
          </div>
          ...
          <div className="rounded-lg bg-muted p-4 space-y-2">
              ...
              <ul className="text-sm text-muted-foreground space-y-1">
                ...
                <li><code className="bg-background px-1 py-0.5 rounded">{"{{stripe.eventType}}"}</code>- Event type (e.g., payment_intent.suceeded)</li>
              </ul>
          </div>
