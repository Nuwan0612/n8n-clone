...
export const CredentialsEmpty = () => {
  ...
  return(
    <EmptyView 
      onNew={handleCreate}
      message="No credentials found. Get started by creating your first credentials"
    />
  )
}
...
const credentialLogos: Record<CredentialType, string> = {
  ...
  [CredentialType.GROQ]: "/groq.png",
  [CredentialType.ANTHROPIC]: "/anthropic.png",
  [CredentialType.OPENAI]: "/openai.png",
}
